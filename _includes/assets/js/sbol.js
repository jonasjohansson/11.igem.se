var SBOL = {
  shapes: [
    ...
    { name: "Operator", path: '<path d="M21,21V79H79V21"/>' },
    {
      name: "ORI",
      path:
        '<path d="M50,17.1A32.8,32.8,0,1,1,17.2,49.9,32.84,32.84,0,0,1,50,17.1m0-2A34.8,34.8,0"/>'
    },
    {
    ...
    },
    {
      name: "Promoter",
      path:
        '<path d="M6.5,99.91V21.61H90.6"/><path d="M67.41,1.62l23.19,20-23.19,20"/>'
    },
    {
  ...
  strokeWidth: 4,
  count: 0,
  max: Math.floor(document.documentElement.scrollHeight / 1000) - 1,
  wait: 1000,
  alive: 6000,
  fade: 1000,
  wrap: ""
