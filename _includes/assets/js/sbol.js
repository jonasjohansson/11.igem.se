var SBOL = {
    shapes: [
        ...
        { name: 'ORI', path: '<path d="M50,17.1A32.8,32.8,0,1,1,17.2,49.9,32.84,32.84,0,0,1,50,17.1m0-2A34.8,34.8,0"/>' },
        {
            ...
            path: '<path d="M12.33,60.87h75.4l-29-20.3"/><path d="M-29.58,21.79-2.76,49.9-29.69,78.12l-.31-10-.06-1.94H-32l-66,.15V35.74l66.3.3h2l0-2,.11-12.27m-2-4.95L-31.69,34-100,33.73V68.37l68-.16L-31.54,83,0,49.9-31.54,16.84Z"/>'
        },
    ...
    strokeWidth: 5,
    count: 0,
    max: Math.floor(document.documentElement.scrollHeight / 500),
    wait: 1000,
    alive: 6000,
    fade: 1000,
    wrap: ''
